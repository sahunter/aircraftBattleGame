...
class Hero(object):
    def __init__(self, screen_temp):
        self.x = 210
        self.y = 700
        self.image = pygame.image.load("./aircraft_pic/hero1.png")
...
class Bullet(object):
    def __init__(self, screen_temp, x_temp, y_temp):
        self.x = x_temp + 40
        self.y = y_temp - 20
        self.image = pygame.image.load("./aircraft_pic/bullet.png")
        self.screen = screen_temp
...
class EnemyPlane(object):
    def __init__(self, screen_temp):
        self.x = 0
        self.y = 0
        self.image = pygame.image.load("./aircraft_pic/enemy0.png")
        self.screen = screen_temp
        # self.bullet_list = []#用来存储子弹对象的引用
